...
urlpatterns = [
    ...
    path('cart_list/', views.cart_list, name='cart_list'), # v
    path('cart_update/', views.cart_update, name='cart_update'), # v
    path('add_cart/', views.add_cart, name='add_cart'), # v
    path('update_cart_product/', views.update_cart_product, name='update_cart_product'), # v
    path('delete_cart_product/', views.delete_cart_product, name='delete_cart_product'), # v
    path('checkout_cart/', views.checkout_cart, name='checkout_cart'), # v
    ...
    path('history_list/', views.history_list, name='history_list'), # v
